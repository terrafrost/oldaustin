(function(window) {
	...
	L.Hash.parseHash = function(hash) {
		...
		if (args.length == 5) {
			...
			var year = args[3];
			var subKeyVisible = parseInt(args[4]);
	...
	L.Hash.formatHash = function(map) {
		...
		var layer;
		for (const [key, value] of Object.entries(yearLayers)) {
	...
	L.Hash.prototype = {
		...
		stopListening: function() {
			...
			this.map.off("overlayadd", this.onMapMove, this);
			this.map.off("overlayremove", this.onMapMove, this);
