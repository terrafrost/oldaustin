(function (factory) {
    ...
    L.extend(L.DomUtil, {
        ...
        /**
         * @constant radians = degrees × p/180°
         */
        DEG_TO_RAD: Math.PI / 180,

        /**
         * @constant degrees = radians × 180°/p
         */
...
*/
    ...
    L.Control.Rotate = L.Control.extend({
        ...
        onAdd: function(map) {            var container = this._container = L.DomUtil.create('div', 'leaflet-control-rotate leaflet-bar');
...
// https://stackoverflow.com/a/4819886/569976
